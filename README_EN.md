...
| Feature | chen-ai | Open WebUI | LobeChat | Chatbox |
|---------|---------|-----------|----------|---------|
| Zero-dependency core | ✅ | ❌ | ❌ | ❌ |
| Sandboxed code execution | ✅ AST-level | ❌ | ❌ | ❌ |
| 12 Chinese LLM providers | ✅ | Partial | Partial | Partial |
| Plan-Execute Agent | ✅ | ❌ | ❌ | ❌ |
| Three-layer memory | ✅ | ❌ | ❌ | ❌ |
| MCP Server ecosystem | ✅ 35 presets | ✅ | Partial | ❌ |
| CLI + Web UI | ✅ | ✅ | ✅ | ✅ |
| Pure Python | ✅ | ✅ | TypeScript | Electron |
